...
componentGen.runActions({name: 'RbGeneratedComponentEsclass', type: 'React.Component', wantMessages: true, wantLoadable: true}).then(checkForErrors).then(removeTestsDirFrom('components/RbGeneratedComponentEsclass')).catch(reportErrorsFor('component/React.Component'));

componentGen.runActions({name: 'RbGeneratedComponentEsclasspure', type: 'React.PureComponent', wantMessages: true, wantLoadable: true}).then(checkForErrors).then(removeTestsDirFrom('components/RbGeneratedComponentEsclasspure')).catch(reportErrorsFor('component/React.PureComponent'));

componentGen.runActions({name: 'RbGeneratedComponentStatelessfunction', type: 'Stateless Function', wantMessages: true, wantLoadable: true}).then(checkForErrors).then(removeTestsDirFrom('components/RbGeneratedComponentStatelessfunction')).catch(reportErrorsFor('component/Stateless Function'));
...
containerGen.runActions({
    ...
    wantMessages: true,
    wantLoadable: true
}).then(checkForErrors).then(removeTestsDirFrom('containers/RbGeneratedContainerPureComponent')).catch(reportErrorsFor('container/React.PureComponent'));
...
containerGen.runActions({
    ...
    wantMessages: true,
    wantLoadable: true
}).then(checkForErrors).then(removeTestsDirFrom('containers/RbGeneratedContainerComponent')).catch(reportErrorsFor('container/React.Component'));
...
containerGen.runActions({
    ...
    wantMessages: true,
    wantLoadable: true
}).then(checkForErrors).then(removeTestsDirFrom('containers/RbGeneratedContainerStateless')).catch(reportErrorsFor('container/Stateless'));
